                    ...
                    while (1) {
                        switch (_context5.prev = _context5.next) {
                            ...
                            case 57:
                                ...
                                (0, _chai.expect)(find((0, _emberTestSelectors.default)('publishmenu-save')).text().trim(), 'published post unpublish button text').to.equal('Un-publish');
                            ...
                            case 99:
                                ...
                                (0, _chai.expect)(find((0, _emberTestSelectors.default)('publishmenu-save')).text().trim(), 'publish menu save button updated after published post is unpublished').to.equal('Un-published');
                            ...
                            case 125:
                                (0, _chai.expect)(find((0, _emberTestSelectors.default)('publishmenu-save')).text().trim(), 'scheduled post button reschedule text').to.equal('Re-schedule');
                            ...
                            case 128:
                                ...
                                (0, _chai.expect)(find((0, _emberTestSelectors.default)('publishmenu-save')).text().trim(), 'publish menu save button text for a rescheduled post').to.equal('Re-scheduled');
                            ...
                            case 137:
                                ...
                                (0, _chai.expect)(find((0, _emberTestSelectors.default)('publishmenu-save')).text().trim(), 'publish menu save button updated after scheduled post is unscheduled').to.equal('Un-schedule');
                            ...
                            case 140:
                                ...
                                (0, _chai.expect)(find((0, _emberTestSelectors.default)('publishmenu-save')).text().trim(), 'publish menu save button updated after scheduled post is unscheduled').to.equal('Un-scheduled');
...
define('ghost-admin/tests/app.lint-test', [], function () {
  ...
  describe('ESLint | app', function () {
    ...
    it('authenticators/oauth2-ghost-b15c0fe3c8b4d20337d5553df75acaae.js', function () {
      // test passed
    });
...
//# sourceMappingURL=tests-0936c8096ab4cb7aaca63a92777a3464.map
